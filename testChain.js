...
try{
    ...
    const validHash = "0000000abc";
    const invalidHash = "000000abc";
    ...
    console.log("测试哈希计算成功");

    //5.测试挖第一个区块
    console.log("5. 测试挖第一个区块:");
    console.log("---开始挖矿...");
    console.time("++挖矿耗时++");
    blockchain.mine("第一个区块");
    ...
    console.log("区块链测试结束,所有测试通过，你的Block.js和Blockchain.js文件运行正常");
